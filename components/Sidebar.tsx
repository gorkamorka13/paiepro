...
import { Home, BarChart3, Settings, HelpCircle, ChevronLeft, ChevronRight, FileText, Sun, Moon } from 'lucide-react';
...
export function Sidebar() {
    ...
    return (
        <aside
            className={`fixed left-0 top-0 h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transition-all duration-300 z-50 flex flex-col ${isCollapsed ? 'w-20' : 'w-64'
                }`}
        >
            {/* Header */}
