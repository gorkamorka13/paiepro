        ...
        <div className="relative min-w-[300px]">
            ...
            <div className="w-full h-full flex items-end justify-around gap-2 px-4 md:px-8 relative z-0">
              {hoursData.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex-1 min-w-[40px] max-w-[100px] flex flex-col items-center group relative h-full justify-end"
                  >
                    {/* Tooltip */}
          ...
          <div className="w-full flex justify-around gap-2 px-4 md:px-8 mt-2">
            {hoursData.map((item, index) => (
              <div
                key={index}
                className="flex-1 min-w-[40px] max-w-[100px] flex justify-center"
              >
